...
choices = ['台積電: 2020.1.2 至 2025.4.16', '大台指期貨2025.12到期: 2020.3.23 至 2025.3.14', '小台指期貨2025.12到期: 2020.3.2 至 2025.3.14', '金融期貨2025.12到期: 2020.3.2 至 2025.4.14', '聯電期貨2025.12到期: 2020.4.17 至 2025.4.16']
choice = st.selectbox('選擇金融商品', choices, index=0)
##### 读取Pickle文件
if choice == choices[0] :         ##'台積電: 2022.1.1 至 2024.4.9':
    df_original = load_data('kbars_1d_2330_2020-01-02_To_2025-04-16.pkl')
...
if choice == choices[1] :                   ##'大台指期貨2024.12到期: 2023.12 至 2024.4.11':
    df_original = load_data('kbars_1d_TXF_2020-03-23_To_2025-03-14.pkl')
    product_name = '大台指期貨'
if choice == choices[2] :                              ##'小台指期貨2024.12到期: 2023.12 至 2024.4.11':
    df_original = load_data('kbars_1d_MXF_2020-03-02_To_2025-03-14.pkl')
    product_name = '小台指期貨'
if choice == choices[3] :                                           ##'英業達2020.1.2 至 2024.4.12':
    df_original = load_data('kbars_1d_FXF_2020-03-02_To_2025-04-14.pkl')
    product_name = '金融期貨'
if choice == choices[4] :                                                       ##'堤維西2020.1.2 至 2024.4.12':
    df_original = load_data('kbars_1d_CCF_2020-04-17_To_2025-04-16.pkl')
    product_name = '聯電期貨'
...
if choice == choices[0] :                       ##'台積電: 2022.1.1 至 2024.4.9':
    start_date = st.text_input('輸入開始日期(日期格式: 2020-01-02), 區間:2020-01-02 至 2025-04-16', '2020-01-02')
    end_date = st.text_input('輸入結束日期 (日期格式: 2025-04-16), 區間:2020-01-02 至 2025-04-16', '2025-04-16')
if choice == choices[1] :                                   ##'大台指期貨2024.12到期: 2023.12 至 2024.4.11':
...
if choice == choices[4] :                                                             ##'堤維西2020.1.2 至 2024.4.12':
    start_date = st.text_input('輸入開始日期(日期格式: 2020-04-17), 區間:2020-04-17 至 2025-04-16', '2020-04-17')
    end_date = st.text_input('輸入結束日期 (日期格式: 2025-04-16), 區間:2020-04-17 至 2025-04-16', '2025-04-16')
